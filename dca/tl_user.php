 ...
 */
$arrDca['palettes']['extend'] = str_replace('formp', 'formp;{competition_legend},competition_submissions,competition_submissionp,competition_reviews,competition_reviewp;', $arrDca['palettes']['extend']);
$arrDca['palettes']['custom'] = str_replace('formp', 'formp;{competition_legend},competition_submissions,competition_submissionp,competition_reviews,competition_reviewp;', $arrDca['palettes']['custom']);
